...
public class BookNowPage {
    ...
    public static By roomTile = By.xpath("//div[contains(@class,'select-room')]/parent::li");
    ...
    public static By successfulBookingMessage = By.xpath("//div[contains(@class,'booking-forms')]/child::h3[@id='thank_message']");
